        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (IsPostBack == false)
                {
                    ...
                    userExamDataSource.ConnectionString = ConfigurationManager.ConnectionStrings["MSSQLLocalDB"].ToString();
                    ...
                    userExamDataSource.InsertParameters.Add("Username", Session["Username"].ToString());
