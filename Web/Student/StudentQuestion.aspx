    ...
    <asp:Panel ID="Panel1" runat="server">
        ...
        <div>
            <table>
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="mqQuestionDesc" DataSourceID="SqlDataSource1" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                            <Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT mq.mqQuestionDesc, mq.mqEachMarks, mq.mqQuestionID FROM Assessments AS a INNER JOIN MultiQuestions AS mq ON a.asID = mq.asID WHERE (mq.asID = @id)">
            <SelectParameters>
